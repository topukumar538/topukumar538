...
- Architected a 3-mode AI assistant (Chat, RAG, Automated Postmortem) with a LangGraph StateGraph pipeline and 3 specialized LLM instances per session
...
- Containerized with Docker, deployed to Hugging Face Spaces with hosted Postgres
...
- Load-tested with Locust: ~800ms p95 latency at 100 concurrent users
